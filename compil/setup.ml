...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3618ac4aa0ab6c6b25049b746964883a) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "graph"];
                      bs_build_tools =
                        [
                   ...
                   {
                      lib_modules =
                        ["Frontend"; "Descr"; "Descr_lexer"; "Descr_parser"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\233<\165}\202\247\245V\142\139\169\208\206\200\233\163";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
