...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7288d3170f696f6ab4ebff363b9960d7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = ["Tricomp"];
          authors = ["Tricomp"];
          homepage = Some "https://github.com/tricomp/tricomp";
          synopsis = "Synopsis";
          description = Some [OASISText.Para "Blablabla."];
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Tricot"; "Descr"; "Descr_lexer"; "Descr_parser"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "utils"; InternalLibrary "tricot"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "utils";
                           InternalLibrary "tricot";
                           InternalLibrary "compil"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/tricomp/tricomp.git";
                      src_repo_browser =
                        Some "https://github.com/tricomp/tricomp";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "vq\007\189;\182\160F\135g\208\139\b\244\185\239";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
