...
(* OASIS_START *)
(* DO NOT EDIT (digest: bc7f641522ecc287f1698391358b6966) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "Synopsis";
          description = Some [OASISText.Para "\"\""];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "tricot"; InternalLibrary "compil"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "w\t\155_\217\252\165\215\218K\004\129\131\154\022>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
